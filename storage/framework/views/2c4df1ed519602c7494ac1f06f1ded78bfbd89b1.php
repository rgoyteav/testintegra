...
<body>
	<h1>Impresión factura de venta - <?php echo e($title); ?></h1>
	<p></p>
	<label for="">ID de factura: <?php echo e($id); ?></label> <br>
	<label for="">Cliente: 
	<?php 
...
</html><?php /**PATH C:\xampp\htdocs\testintegra\resources\views/pdf/factura.blade.php ENDPATH**/ ?>