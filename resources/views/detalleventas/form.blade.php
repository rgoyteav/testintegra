...
<script type="text/javascript">
	$(window).load(function() {
		...
		$.ajax({
	        ...
	        type: "GET",
	        dataType: "json",
	        url:"{{ route('detalleventas.obtenerIdVenta') }}",
	    ...
	    $.ajax({
            type: "GET",
            dataType: "json",
            url: "{{ route ('detalleventas.obtenerClientes') }}",
            success: function(response)
            {
	    ...
	    $.ajax({
            type: "GET",
            dataType: "json",
            url: "{{ route ('detalleventas.obtenerEmpleados') }}",
            success: function(response)
            {
	    ...
	    $.ajax({
            type: "GET",
            dataType: "json",
            url: "{{ route ('detalleventas.obtenerProductos') }}",
            success: function(response)
            {
            	$.each(response,function(key, producto) {
...
<script>
	function llenarLista() {
		...
		$.ajax({
            ...
            type: "GET",
            dataType: "json",
            url:"{{ route('detalleventas.obtenerPrecioProducto') }}",
            success: function(response){
            	$.each(response,function(key, producto) {
            		if (valor == key+1) {
